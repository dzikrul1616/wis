                            ...
                            <a href="javascript:;" class="nav-link text-white p-0" id="dropdownMenuButton"
                                ...
                                <i class="fa fa-bell cursor-pointer">
                                    @php
                                        ...
                                        $pendingCount = Partner::where('status_partner', 'PENDING')->count();
                                ...
                                @foreach ($partner as $row)
                                    <li class="mb-2">
                                        <a class="dropdown-item border-radius-md" href="#" data-bs-toggle="modal"
                                            data-bs-target="#detailPartner{{ $row->id }}">
                                            <div class="d-flex py-1">
                                                <div class="my-auto">
                                                    <img src="{{ asset('partner/photo/' . $row->partner_image) }}"
                                                        class="avatar avatar-sm  me-3 ">
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="text-sm font-weight-normal mb-1">
                                                        <span class="font-weight-bold">New partner</span> request
                                                    </h6>
...
@foreach ($partner as $row)
    <div class="modal fade" id="detailPartner{{ $row->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="partner_name" value="{{ $row->partner_name }}" type="text"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="partner_email" value="{{ $row->partner_email }}" type="email"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input id="phone" value="{{ $row->partner_phone }}" name="partner_phone"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <a target="_blank" href="{{ asset('partner/photo/' . $row->partner_image) }}">
                                    <div class="card">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <a target="_blank" href="{{ asset('partner/license/' . $row->license) }}">
                                    <div class="card">
                                        <div style="color:darkgray" class="card-body">
                ...
                <div class="modal-footer">
                    ...
                    <form method="post" action="{{ route('partner-updateStatusPartner', ['id' => $row->id]) }}"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="status_partner" id="status">
                        <button id="btn-confirm-approve" data-partner-name="{{ $row->partner_name }}"
                            style="color: white; background-color:#00796B" type="submit" class="btn btn-approve"> <i
                                class="fa fa-check"></i> Approve</button>

                        <button id="btn-confirm-reject" data-partner-name="{{ $row->partner_name }}"
