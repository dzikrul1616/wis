...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link " href="{{ route('admin-partner-manage') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="newsDropdown">
                <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin-news-list') }}">List News</a>
                    </li>
                    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#transactionDropdown"
                aria-expanded="false" aria-controls="transactionDropdown">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="collapse" id="transactionDropdown">
                <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="#">Manage Transaction</a>
                    </li>
                    {{-- <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin-news-category-manage') }}">Manage News =</a>
                    </li> --}}
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link " href="{{ route('admin-tasker-manage') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
